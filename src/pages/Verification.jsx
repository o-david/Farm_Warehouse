...
const Verification = () => {
  ...
  return (
    <div className="flex h-[100vh]">
      ...
      <div className="lg:pl-[4rem] lg:py-[3rem] border w-full lg:w-[51.39%]">
